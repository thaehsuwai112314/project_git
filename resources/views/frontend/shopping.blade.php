			...
			<div class="table-responsive">
				<table class="table text-center">
					...
					<tfoot id="shoppingcart_tfoot" class="text-right">
						...
						<tr> 
							<td colspan="5"> 
								<textarea class="form-control notes" placeholder="Any Request..." name="area" required="required"></textarea>
							...
							<td colspan="3">
								...
								@else
								<a href="{{route('loginpage')}}" class="btn btn-secondary btn-block mainfullbtncolor checkoutbtn buy_now">Login To Check Out</a>
								@endrole
							</td>
						</tr>
					</tfoot>
