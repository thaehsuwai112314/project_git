...
<body>
	<div class="container-fluid">
		...
		<div class="row shadow-sm p-3 bg-white rounded d-flex align-items-center">
			...
			<div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6 order-xl-3 order-lg-3 order-md-4 order-sm-4 order-4 text-right">
				...
				<a href="{{route('shoppingpage')}}" class="text-decoration-none d-xl-inline d-lg-inline d-md-inline d-sm-none d-none shoppingcartLink"> 
					<i class="icofont-shopping-cart"></i> 
					<span class="badge badge-pill badge-light badge-notify cartNotistyle cartNoti cartnoti">0</span>
					<span class="total"></span>Ks
				</a>
						...
						<li class="dropdown-submenu">
							...
							<ul class="dropdown-menu">
								...
								<h6 class="dropdown-header">
									@if($category->id==$subcategory->category_id){{$subcategory->name}}
									@endif
								</h6>
								@endforeach	
							</ul>
	...
	<div id="mySidebar" class="sidebar">
		...
		<div class="mt-3">
			...
			<a href="{{route('loginpage')}}|{{route('registerpage')}}"> Login </a>
